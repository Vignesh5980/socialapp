...
# from django.contrib.auth.tokens import make_token
...
def index(request):
    ...
    return render(request, 'index.html', {'user_profile':user_profile, 'posts':feed_list, 'final_suggestions_list':final_suggestions_list, 'suggestions_username_profile_list':suggestions_username_profile_list[:4]} )
